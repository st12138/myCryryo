...
public class mySM3 {
    ...
    public static String hashFile(String path) throws IOException {
        ...
        return mySM3.byteArrayToHexString(mySM3.hash(buf2));
    }

    public static  boolean compFile(String path,String hash) throws IOException {
        String hash1 = hashFile(path);
        return hash1.equals(hash);
    }
    public static void main(String[] args) throws IOException {

        //this is a test
        String s1 = hashFile("/Users/aris/IdeaProjects/demo/src/main/java/com/example/demo/西游记.txt");
        System.out.println(s1);
        System.out.println(compFile("/Users/aris/IdeaProjects/demo/src/main/java/com/example/demo/西游记.txt",s1));
